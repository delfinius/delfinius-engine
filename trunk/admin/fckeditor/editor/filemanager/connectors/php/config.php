...
$Config['FileTypesPath']['File']		= $Config['UserFilesPath'] . 'attachments/' ;
$Config['FileTypesAbsolutePath']['File']= ($Config['UserFilesAbsolutePath'] == '') ? '' : $Config['UserFilesAbsolutePath'].'file/attachments/' ;
